...
function Step2_Interview({interviewData , onFinish}) {
    ...
    const speakText = (text) => {
        return new Promise((resolve) => {
            ...
            // Add naturral pauses after commas and periods
    ...
    useEffect(() => {
        ...
        const runIntro = async () => {
            if(isIntroPhase){
                await speakText(
                    `Hi ${userName},it's great to see you today. I hope you're feeling confident and ready.`
                );
        ...
        <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-100 flex items-center justify-center p-4 sm:p-6">
            <div className="w-full max-w-5xl min-h-[80vh] bg-white rounded-3xl shadow-2xl border border-gray-200 flex flex-col lg:flex-row overflow-hidden">
                ...
                <div className="flex-1 flex flex-col p-4 sm:p-6 md:p-8 relative">
                    ...
                    value={answer}
                    className="flex-1 w-full bg-gray-50 p-4 sm:p-6 rounded-2xl resize-none outline-none border-2 border-gray-200 focus:ring-2 focus:ring-emerald-500 transition text-gray-800"/>
...
export default Step2_Interview;