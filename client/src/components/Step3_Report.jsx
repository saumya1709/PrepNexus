...
function Step3_Report({report}) {
    ...
    const questionWiseScoreData = questionWiseScore.map((score,index)=>({
        name: `Q${index+1}`,
        score: score.score || 0
    }))
    ...
    if(finalScore >= 8){
        performanceText = "Readdy for job opportunities.";
                            ...
                            {questionWiseScore.map((q,i)=>(
                                <div key={i} className="bg-gray-50 p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-gray-200">
                                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 mb-4">
                                        ...
                                        <div className="bg-green-100 text-green-600 px-3 py-1 rounded-full font-bld text-xs sm:text-sm w-fit">
                                            {q.score ?? 0}/10
